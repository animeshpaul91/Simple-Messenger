        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                ...
                while (true) {
                    ...
                    Log.d(TAG, "Message Received from Client: "+msgFromClient);
                    if (msgFromClient != null) {
                        PrintWriter pw = new PrintWriter(server.getOutputStream(), true);
                        pw.println(msgFromClient);
                        Log.d(TAG, "Message Sent to Client: "+msgFromClient);
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                try {
                    ...
                    output.flush();
                    Log.d(TAG, "Message sent to Server: "+msgToSend);
                }
                catch (IOException e)
                {
                ...
                while(!msgfromServer.equals(msgToSend));
                Log.d(TAG, "Message Received from Server: "+msgfromServer);
                Log.d(TAG, "Two way Handshake Complete");
                ip.close();
                socket.close();
